...
**Does Mein Scope require an internet connection to work?**
> No. Patient data is stored locally on the device, and intake, capture, and reporting all work fully offline. You don't need a connection for day-to-day use.

**Where is patient data stored?**
> On the device itself, using local browser storage (IndexedDB). There's no cloud server involved in day-to-day use.

**Can multiple devices access the same patient records?**
